...
const categories = [
  ...
  { id: "metodologia", label: "Metodología", icon: Rocket },
  { id: "capacidades", label: "Capacidades", icon: Code2 },
  { id: "casos", label: "Casos", icon: Building2 },
  { id: "alianzas", label: "Alianzas", icon: Building2 },
...
const faqDatabase: FAQItem[] = [
  ...
  // METODOLOGÍA
  {
    ...
    answer: "Nuestra metodología se basa en 4 pasos:\n\n1. Diagnóstico Profundo: Entendemos tu negocio, procesos, equipo y datos.\n2. Diseño a Medida: Cada propuesta es específica, sin plantillas genéricas.\n3. Implementación Iterativa: Ciclos cortos con validaciones frecuentes.\n4. Transferencia y Autonomía: Tu equipo aprende a operar sin nosotros.\n\nResultados, no promesas.",
    keywords: ["metodologia", "enfoque", "como trabajan", "proceso", "metodo", "pasos"],
  },
  {
    id: "filosofia",
    category: "metodologia",
    question: "¿Cuál es su filosofía?",
    answer: '"La IA no reemplaza a las personas. Potencia a quienes saben usarla."\n\nNos comprometemos con resultados, no vendemos software. Trabajamos de manera cercana con tu equipo para transferir conocimiento y construir capacidades duraderas.',
    keywords: ["filosofia", "frase", "cita", "pensamiento"],
  },
  ...
  // CAPACIDADES IA
  {
    ...
    question: "¿Qué capacidades de IA ofrecen?",
    answer: "Nuestras capacidades incluyen:\n\n- LLMs y Agentes: Asistentes conversacionales y agentes autónomos.\n- Automatización de Procesos: Flujos IA que liberan tiempo de tu equipo.\n- Datos y Analytics: Pipelines y dashboards que convierten datos en decisiones.\n- Gobernanza y Seguridad IA: Marcos para adoptar IA con responsabilidad.",
    keywords: ["capacidades", "ia", "inteligencia artificial", "servicios ia", "agentes", "llms"],
  },
  {
    id: "llm-agentes",
    category: "capacidades",
    question: "¿Qué son los LLMs y Agentes?",
    answer: "Implementamos asistentes conversacionales y agentes autónomos integrados a tu operación. Desde chatbots inteligentes hasta agentes que ejecutan tareas complejas de forma autónoma.\n\nTecnologías: GPT, Claude, modelos Open Source, RAG.",
    keywords: ["llm", "agentes", "gpt", "chatbot", "conversacional", "claude"],
  },
  {
    id: "automatizacion",
    category: "capacidades",
    question: "¿En qué consiste la automatización de procesos?",
    answer: "Creamos flujos de IA que liberan tiempo de tu equipo y reducen errores. Automatización inteligente de procesos operativos, documentación y validaciones.\n\nTecnologías: RPA, Workflows, NLP, OCR.",
    keywords: ["automatizacion", "procesos", "rpa", "workflow", "automatizar"],
  },
  {
    id: "datos-analytics",
    category: "capacidades",
    question: "¿Qué ofrecen en datos y analytics?",
    answer: "Construimos pipelines y dashboards que convierten datos en decisiones. Infraestructura de datos moderna con capacidades de análisis predictivo y prescriptivo.\n\nIncluye: Data Pipelines, Dashboards, Análisis Predictivo, Tiempo Real.",
    keywords: ["datos", "analytics", "dashboard", "pipelines", "predictivo", "analisis"],
  },
  {
    id: "gobernanza-ia",
    category: "capacidades",
    question: "¿Cómo manejan la gobernanza y seguridad de IA?",
    answer: "Implementamos políticas y marcos de gobernanza para adoptar IA con responsabilidad. Cubrimos cumplimiento normativo, ética algorítmica y seguridad en sistemas de IA.\n\nÁreas: Ética, Cumplimiento, Auditoría, Privacidad.",
    keywords: ["gobernanza", "seguridad", "etica", "cumplimiento", "regulacion", "privacidad"],
  },
  ...
  // CASOS DE CLIENTES
  {
    id: "casos-clientes",
    category: "casos",
    question: "¿Qué resultados han logrado con clientes?",
    answer: "Algunos resultados destacados:\n\n- Food Tech: Alertas predictivas 4h antes de falla, 80% menos reportes manuales\n- Retail: 70% de consultas automatizadas, NPS +22 puntos en 90 días\n- Industrial: 30% menos paradas no planificadas, ROI positivo en mes 4\n\n¿Tu empresa podría ser el próximo caso?",
    keywords: ["casos", "resultados", "clientes", "proyectos", "impacto", "metricas"],
  },
  ...
  // ALIANZAS
  {
    id: "alianzas",
    category: "alianzas",
    question: "¿Con quiénes tienen alianzas?",
    answer: "Trabajamos con un ecosistema de socios estratégicos:\n\n- HablaIP: Telecomunicaciones\n- RiverLogic: Consultoría Empresarial\n- Orden y Soluciones: Software & Negocio\n- AxisDynamics: IA Avanzada\n- Kyon XR: XR & Gemelos Digitales\n\nJuntos ofrecemos soluciones completas a nuestros clientes.",
    keywords: ["alianzas", "socios", "partners", "ecosistema", "hablaip", "riverlogic"],
  },
  ...
  // INSIGHTS
  {
    id: "insights",
    category: "insights",
    question: "¿Qué insights comparten?",
    answer: "Compartimos contenido en 5 categorías:\n\n- Artículos: Guías prácticas y análisis técnicos\n- Libros: Recomendaciones de lectura\n- Eventos: Meetups y workshops\n- Podcasts: Conversaciones sobre IA y tecnología\n- Tendencias: Lo que viene en el mundo tech\n\nTodo diseñado para líderes que quieren tomar mejores decisiones con IA.",
    keywords: ["insights", "articulos", "libros", "eventos", "podcasts", "tendencias"],
  },
                    ...
                    {categories.map((cat) => (
                      <button
                        ...
                        onClick={() => handleOptionClick(
                          ...
                          cat.id === "metodologia" ? "metodologia" :
                          cat.id === "capacidades" ? "capacidades-ia" :
                          cat.id === "casos" ? "casos-clientes" :
                          cat.id === "alianzas" ? "alianzas" :
                          cat.id === "insights" ? "insights" :
